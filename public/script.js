            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-3 d-flex align-items-stretch reveal1">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-primary mx-2 sans btn-size" href="${readurl}" target="_blank">Read Online</a><br><br>
                                        <form action="/addToList" method="post">
                                            ...
                                            <input type="text" name="bookName" value = "${name}" id="" hidden>
                                            <input type="text" name="subName" value = "${subName}" id="" hidden>
                                            <input type="text" name="imgurl" value = "${imgurl}" id="" hidden>
                                            <input type="text" name="readurl" value = "${readurl}" id="" hidden>
                                            <input type="text" name="author" value = "${author}" id="" hidden>
                                            <button type="submit" class="btn btn-primary btn-size">Add to my list</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 my-3 d-flex align-items-stretch reveal1">
                                <div class="card text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text sans text-center ">${subName}</p>
                                        <p class="card-text sans text-center ">Author : ${author}</p>
                                        <a class="btn btn-primary mx-2 sans" href="${readurl}" target="_blank">Read Online</a><br><br>
                                        <form action="/addToList" method="post">
                                            <input type="text" name="userEmail" value = "<%= userEmail %>" id="" hidden>
                                            <input type="text" name="userName" value = "<%= userName %>" id="" hidden>
                                            <input type="text" name="bookName" value = "${name}" id="" hidden>
